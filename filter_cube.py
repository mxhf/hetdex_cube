...
parser.add_argument("-t", "--threshold", type=float,  default=0.5,
                    help="Threshold for continuum signal masking (defualt 0.5, godd for uncalibrated cubes. Try 0.01 for calibrated cubes (in 1e-17 erg/s/cm^s/A/arcsec).")
...
print("Masking everything with wavelength median above {}".format(args.threshold))
